...
#****************** Implicit wait***************
# - Global wait for all driver command
# - Implicit wait provide max time to wait if command not executed but if it executed before defined wait then it resumes automatically
# - Implicit wait is intellegene wait
# 
driver.implicitly_wait(5) #5sec wait (max timeout for 5sec)
